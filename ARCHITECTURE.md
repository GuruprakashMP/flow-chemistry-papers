...
primary flow-chemistry terms (required) + support terms, with negative terms
for neighbouring fields that merely share the word "flow" (flow cytometry,
blood flow, CFD/heat-transfer, traffic/hydrology, nuclear reactors) and a
bonus for chemistry/engineering venues.
...
clamped to 0–100; acceptance requires primary evidence (≥4 points) plus the
