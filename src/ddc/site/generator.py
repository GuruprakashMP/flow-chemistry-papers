...
flow chemistry research papers — continuous-flow synthesis, microreactors and
microfluidics, telescoped and multistep processes, flow photochemistry and
electrochemistry, catalysis in flow, in-line analytics and PAT, process
intensification, scale-up/numbering-up and continuous manufacturing — covering
synthetic, engineering and computational studies alike.</p>
<h2>How it works</h2>
<p>Every day an automated pipeline queries open scholarly metadata APIs,
removes duplicates, classifies each paper with a flow-chemistry relevance
