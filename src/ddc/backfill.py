"""Historical backfill — index the whole history of flow chemistry.

Walks OpenAlex (which aggregates Crossref, PubMed, arXiv and more, with
abstracts for classification) using cursor pagination:

* **Topic sweep**: a set of broad flow-chemistry search queries, one year at a
